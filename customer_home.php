              ...
              <div class="hamburger"></div>
                <ul class="navigationContents">
                    ...
                    <div class="homeNavContainer">
                      ...
                      <li><a href="customer_home.php" class="activeNav homeNav">Home</a></li>
                    </div>
                    <h1 class="divider">|</h1>
                    ...
                    <div class="productsNavContainer">
                      ...
                      <li><a href="product.php" class="productsNav">Products</a></li>
                    </div>
                    <h1 class="divider">|</h1>
                    ...
                    <div class="faqsNavContainer">
                      ...
                      <li><a href="Faqs.php" class="faqsNav">FAQs</a></li>
                    </div>
                    <h1 class="divider">|</h1>
